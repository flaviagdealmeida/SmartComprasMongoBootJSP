		...
		<nav class="navbar navbar-inverse" id="menu">
			...
			<div class="container-fluid">
				<div class="collapse navbar-collapse"
					...
					<c:if test ="${empty carrinho2 or carrinho2.total eq 0}"> 
						<span>Carrinho vazio</span>
					</c:if>
					<%--
					<c:if test="${carrinho2.total > 0}">
						<ul class="nav navbar-nav navbar-right clearfix">
							<li class="active"><a href="#" rel="nofolow">Sua
									Lista(${carrinho2.total}) </a>
							</li>
							<li><a href="<c:url value="/carrinho"/>"></a></li>
						</ul>
					</c:if> --%>
				</div>
			</div>
				...
				<table class="table table-striped table-hover " id="titulos">
					...
					<tbody>
						...
						<tr>
							...
							<form action="<c:url value="/carrinho2"/>" method="POST">
									<input type="hidden" name="item.produto.id" value="${produto.id}" />
									<input type="number" size="10" min="1" name="item.quantidade" value="1"/>
