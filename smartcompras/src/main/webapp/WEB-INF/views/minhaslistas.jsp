	...
	<div class="container">
		<div class="container-fluid" id="form-listagem">
			<form action="/delitem" method="POST">
				<fieldset>
					<legend>Listagem de Compras</legend>
						...
						<c:forEach var="item" items="${itemLista}">
							<tbody>
								<tr>
									...
									<td class="coluna"><button class="btn btn-danger btn-sm" type="submit" value=${item.id } name="removerItem">
											<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
								<i class="fa fa-trash fa-lg" aria-hidden="true"></i></button></td>
								</tr>
								<tr>
									<c:forEach var="itemProduto" items="${item.produtos}" varStatus="index">
										<tbody>
											<tr>
												<td>
